...
import { signin, refreshToken } from "../api/Auth"; // refreshToken added
...
export default function LoginForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Step 2: immediately fetch new accessToken from backend
      ...
      >
        <div className="flex flex-col items-center mt-16 mb-12 w-full z-10">
          <div className="w-14 h-14 mb-3 flex items-center justify-center rounded-full bg-white bg-opacity-10">
            <svg width="32" height="32" fill="none" viewBox="0 0 32 32">
              ...
              <path
                d="M8 18c2.1-1.5 6.27-3.33 8.27-2.97C18.85 15.16 24 17.5 24 17.5"
                stroke="#6366F1"
                strokeWidth="2.2"
                strokeLinejoin="round"
              />
              <path
                d="M8 12.5C11 11 17.36 11 24 15.5"
                stroke="#6366F1"
                strokeWidth="2.2"
                strokeLinejoin="round"
              />
          ...
          <div className="text-white text-4xl font-bold tracking-wide mt-3">
            BASE
          </div>
        </div>
        <div className="flex space-x-7 mb-10 z-10">
          <a
            ...
            className="text-white text-2xl opacity-90 hover:opacity-100"
          >
            <FaGithub />
          </a>
          <a
            href="https://x.com/abhishekpa78700"
            className="text-white text-2xl opacity-90 hover:opacity-100"
          >
            <FaTwitter />
          </a>
          <a
            href="http://www.linkedin.com/in/abhishek-patil-a0a82431a"
            className="text-white text-2xl opacity-90 hover:opacity-100"
          >
            <FaLinkedin />
          </a>
          <a
            href="https://discord.com/users/prime096345"
            className="text-white text-2xl opacity-90 hover:opacity-100"
          >
            <FaDiscord />
          </a>
        ...
        <div className="bg-white px-8 py-10 rounded-2xl shadow-md w-full max-w-md mx-4">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex justify-end mb-2">
              <a href="#" className="text-indigo-600 text-xs hover:underline">
                Forgot password?
              </a>
            </div>
            <button
